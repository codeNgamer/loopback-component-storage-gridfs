 ...
 */
GridFSService.prototype.download = function (containerName, fileId, res, options, cb) {
  var self = this;
  ...
  collection.find({
    ...
    // backword compatibility while supporting passing alternate stream from node res
    if (_.isFunction(options)) {
      ...
      if (options.stream) res = options.stream;
    }
